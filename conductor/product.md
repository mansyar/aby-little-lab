...
- **Replay Variety:** Items/shapes/animals shuffle per playthrough; difficulty stays fixed. *(Amended 2026-08-27: in the four early-numeracy games, difficulty may now shift ±1 band per playthrough via Adaptive Difficulty above; all other games remain fixed-difficulty.)*

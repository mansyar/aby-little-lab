...
- [x] Task: Create game scene stubs [b8d72ae]
    - [x] Create `src/scenes/ShapeSorterScene.ts` (placeholder UI + back button with ParentLock)
    - [x] Create `src/scenes/AnimalTraceScene.ts` (placeholder UI + back button with ParentLock)
    - [x] Create `src/scenes/PopFreezeScene.ts` (placeholder UI + back button with ParentLock)
    - [x] Create `src/scenes/ShadowMatchScene.ts` (placeholder UI + back button with ParentLock)

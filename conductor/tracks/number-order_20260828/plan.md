...
- [x] Task 2.1: `NumberOrderScene` (inherits GameSceneBase) — drag-to-slots + auto-validate (TDD where logic, visual verification otherwise) [9ce2a8c]
...
- [x] Task 3.2: GameId, registry, Hub 5×4 grid (TDD for storage/registry, visual for layout)

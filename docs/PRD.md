...
This document defines the production requirements for an ad-free, distraction-free developmental game suite tailored for 3–5 year-old preschoolers. The app packages **17 distinct mini-games** into a single lightweight web app targeting fundamental cognitive, motor, and reasoning benchmarks.
...
[PreloadScene]
    ...
    │  sticker, Games 9 & 10 letter/animal/food/object textures +
     │  stickers — all 17 games'
    │  assets loaded)
    │
    ▼
[HubScene]
    │
    ├── Display 17 game tiles (grid, 5×3 + 2 — row 4 holds 2 left-aligned tiles)

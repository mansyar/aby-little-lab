...
This document defines the production requirements for an ad-free, distraction-free developmental game suite tailored for 3–5 year-old preschoolers. The app packages **16 distinct mini-games** into a single lightweight web app targeting fundamental cognitive, motor, and reasoning benchmarks.
...
[PreloadScene]
    ...
    │  sticker, Games 9 & 10 letter/animal/food/object textures +
     │  stickers — all 16 games'
    │  assets loaded)
    │
    ▼
[HubScene]
    │
    ├── Display 16 game tiles (grid, 5×3 + 1 — row 4 holds 1 left-aligned tile)

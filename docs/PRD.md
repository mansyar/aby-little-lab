...
This document defines the production requirements for an ad-free, distraction-free developmental game suite tailored for 3–5 year-old preschoolers. The app packages **15 distinct mini-games** into a single lightweight web app targeting fundamental cognitive, motor, and reasoning benchmarks.
...
[PreloadScene]
    ...
    │  sticker, Games 9 & 10 letter/animal/food/object textures +
     │  stickers — all 15 games'
    │  assets loaded)
    │
    ▼
[HubScene]
    │
    ├── Display 14 game tiles (grid, 5×3)

...
- **Target:** live URL `https://aby-little-lab.ansyar-world.top/` (v1.13.0 — Games 15 & 16 + Perf/Bundle Hardening)
- **Scope:** Game 15 (Color Match), Game 16 (Add It Up), Performance & Bundle Hardening spot-check (vendor code-split, coverage guardrail, boot profiling) — see `docs/perf-baseline.md`
